						...
						for ( $i=1 ; $i <= 2 ; $i++) :
							...
							if( $pdf ):
								...
								<div class="pdf-item">
										...
										<a href="<?php echo esc_attr($url); ?>" target="_blank" rel="noopener noreferrer" title="<?php echo esc_attr($title); ?>" class="pdf-text">
											<h3><?php echo esc_html($caption); ?></h3>
											<p><?php esc_html_e('PDFダウンロード','project_nc'); ?></p>
										</a>
								</div>
